...
<div id="contact-wrapper" class="lg:max-w-lg fixed right-0 translate-x-full top-0 bottom-0 z-20 transition-all">
    <!-- Botón que controla la visibilidad del navbar en móvil  -->
...
<header class="sticky top-0 left-0 right-0 z-10">
    ...
    <div class="md:min-h-[90px] py-3 grid grid-cols-3 items-center px-6 bg-white text-denny-dark-300 shadow-md lg:relative">
        ...
        <!-- Navbar -->
        <nav
            class="absolute lg:min-h-min left-0 right-0 -top-[250%] lg:static lg:top-auto justify-self-start z-20 transition-all ease-in-out delay-75 overflow-y-scroll lg:overflow-y-visible h-64 lg:h-auto bg-white"
            id="nav-menu"
        ...
        >
            <ul class="flex flex-col lg:flex-row lg:gap-2">
                ...
                <li id="btn-submenu" class="font-bold border-b border-denny-light-100 lg:border-0 p-2 lg:p-0">
                    <span class="py-2 px-3 rounded-3xl hover:bg-denny-light-200 transition ease-in delay-75 cursor-pointer">
                        Productos
                    </span>
                            ...
                            <div class="lg:flex lg:w-2/5 justify-between">
                                ...
                                <div>
                                    ...
                                    <ul class="lg:flex lg:flex-col gap-2 grid grid-cols-2 md:grid-cols-4">
                                        ...
                                        <li class="ml-2 lg:ml-0">
                                            <a
                                                href="<?= url_to('website.categories.chocolates') ?>"
                                                role="menuitem"
                                                class="hover:text-denny-blue-100"
                                            >
                                                Chocolates
                                        ...
                                        <li class="ml-2 lg:ml-0">
                                            <a
                                                href="<?= url_to('website.categories.paletas') ?>"
                                                role="menuitem"
                                                class="hover:text-denny-blue-100"
                                            >
                                                Paletas
                                        ...
                                        <li class="ml-2 lg:ml-0">
                                            <a
                                                href="<?= url_to('website.categories.caramelos') ?>"
                                                role="menuitem"
                                                class="hover:text-denny-blue-100"
                                            >
                                                Caramelos
                                        ...
                                        <li class="ml-2 lg:ml-0">
                                            <a
                                                href="<?= url_to('website.categories.enchilados') ?>"
                                                role="menuitem"
                                                class="hover:text-denny-blue-100"
                                            >
                                                Dulces enchilados
                                        ...
                                        <li class="ml-2 lg:ml-0">
                                            <a
                                                href="<?= url_to('website.categories.botanas') ?>"
                                                role="menuitem"
                                                class="hover:text-denny-blue-100"
                                            >
                                                Botanas
                                        ...
                                        <li class="ml-2 lg:ml-0">
                                            <a
                                                href="<?= url_to('website.categories.chicles') ?>"
                                                role="menuitem"
                                                class="hover:text-denny-blue-100"
                                            >
                                                Chicles
                                        ...
                                        <li class="ml-2 lg:ml-0">
                                            <a
                                                href="<?= url_to('website.categories.gomitas') ?>"
                                                role="menuitem"
                                                class="hover:text-denny-blue-100"
                                            >
                                                Gomitas
                                        ...
                                        <li class="ml-2 lg:ml-0">
                                            <a
                                                href="<?= url_to('website.categories.bombones') ?>"
                                                role="menuitem"
                                                class="hover:text-denny-blue-100"
                                            >
                                                Bombones
                                        ...
                                        <li class="ml-2 lg:ml-0">
                                            <a
                                                href="<?= url_to('website.categories.tipicos') ?>"
                                                role="menuitem"
                                                class="hover:text-denny-blue-100"
                                            >
                                                Dulces típicos
                                        ...
                                        <li class="ml-2 lg:ml-0">
                                            <a
                                                href="<?= url_to('website.categories.surtidos') ?>"
                                                role="menuitem"
                                                class="hover:text-denny-blue-100"
                                            >
                                                Surtidos
                                ...
                                <div>
                                    ...
                                    <ul class="lg:flex lg:flex-col gap-2 grid grid-cols-2 md:grid-cols-4">
                                        <li class="ml-2 lg:ml-0">
                                            <a
                                                href="<?= url_to('website.seasons.cumpleanos') ?>"
                                                role="menuitem"
                                                class="hover:text-denny-blue-100"
                                            >
                                                Cumpleaños
                                        ...
                                        <li class="ml-2 lg:ml-0">
                                            <a
                                                href="<?= url_to('website.seasons.mesas') ?>"
                                                role="menuitem"
                                                class="hover:text-denny-blue-100"
                                            >
                                                Mesa de dulces
                                        ...
                                        <li class="ml-2 lg:ml-0">
                                            <a
                                                href="<?= url_to('website.seasons.valentin') ?>"
                                                role="menuitem"
                                                class="hover:text-denny-blue-100"
                                            >
                                                San Valentín
                                        ...
                                        <li class="ml-2 lg:ml-0">
                                            <a
                                                href="<?= url_to('website.seasons.nino') ?>"
                                                role="menuitem"
                                                class="hover:text-denny-blue-100"
                                            >
                                                Dia del niño
                                        ...
                                        <li class="ml-2 lg:ml-0">
                                            <a
                                                href="<?= url_to('website.seasons.madres') ?>"
                                                role="menuitem"
                                                class="hover:text-denny-blue-100"
                                            >
                                                Dia de la madre
                                        ...
                                        <li class="ml-2 lg:ml-0">
                                            <a
                                                href="<?= url_to('website.seasons.patrias') ?>"
                                                role="menuitem"
                                                class="hover:text-denny-blue-100"
                                            >
                                                Fiestas patrias
                                        ...
                                        <li class="ml-2 lg:ml-0">
                                            <a
                                                href="<?= url_to('website.seasons.muertos') ?>"
                                                role="menuitem"
                                                class="hover:text-denny-blue-100"
                                            >
                                                Dias de muertos
                                        ...
                                        <li class="ml-2 lg:ml-0">
                                            <a
                                                href="<?= url_to('website.seasons.navidad') ?>"
                                                role="menuitem"
                                                class="hover:text-denny-blue-100"
                                            >
                                                Navidad
                            ...
                            <div class="hidden my-4 lg:my-0 lg:w-2/5 lg:flex gap-4 flex-col lg:flex-row">
                                <article class="lg:w-1/2 p-4 bg-denny-blue-100 text-white rounded-2xl min-h-[250px] flex items-center">
                                    <div class="-rotate-90">
                                        ...
                                        <p class="outline__text text-5xl">
                                            Promos
                                        </p>
                                    </div>
                                    <a
                                        href="<?= url_to('website.pages.promotions') ?>"
                                ...
                                <article class="lg:w-1/2 p-4 bg-denny-purple text-white rounded-2xl min-h-[250px] flex flex-col items-center justify-center">
                                    ...
                                    <a
                                        href="<?= url_to('website.brands.index') ?>"
                ...
                <li class="font-bold border-b border-denny-light-100 lg:border-0 p-2 lg:p-0">
                    <a
                        href="<?= url_to('website.pages.about') ?>"
                        role="menuitem"
                ...
                <li class="font-bold border-b border-denny-light-100 lg:border-0 p-2 lg:p-0">
                    <a
                        href="<?= url_to('website.pages.offices') ?>"
                        role="menuitem"
                        class="py-2 px-3 rounded-3xl hover:bg-denny-light-200 transition ease-in delay-75"
                    >
                        Sucursales
        ...
        <a
            href="<?= url_to('website.pages.home') ?>"
            class="inline-flex w-28 md:w-36 md:-mt-11 justify-self-center"
        >
            <img
                src="<?= base_url('logo.svg') ?>"
                alt="Dulcerías Denny Logo"
                class="w-3/4 md:w-full h-full object-cover"
            >
        </a>
        <!-- Fin del logo de la compañía -->

        <!-- Botón que muestra el formulario de contacto -->
