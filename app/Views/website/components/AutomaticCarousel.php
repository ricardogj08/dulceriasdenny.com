...
<section class="relative overflow-hidden">
        ...
        <div class="carousel flex transition-transform delay-100" aria-label="carousel">
            <article class="relative flex-shrink-0 w-full h-full">
                <picture class="w-full h-full block relative md:static">
                    <img
                        src="<?= base_url('images/pages/home/banner.webp') ?>"
                        alt="Banner - Dulcerias Denny" class="w-full h-full object-cover"
                    >
                    <h2 class="absolute top-1/2 right-0 -translate-y-1/2 text-denny-blue-300 text-xl font-black md:hidden w-1/2">
                        Paquetes para Fiesta al 50% de Descuento
                    </h2>
                </picture>
                <div class="md:absolute md:top-1/2 md:right-0 md:-translate-y-1/2 md:w-7/12 md:px-2">
                    <h2 class="text-denny-blue-300 text-lg md:text-3xl lg:text-5xl font-black hidden md:block">
                        Paquetes para Fiesta al 50% de Descuento
                    </h2>
                    <p class="text-denny-purple text-sm md:text-md lg:text-2xl lg:mt-4 lg:mb-8 font-medium">
                        No pierdas tiempo y dinero, nosotros te enviamos el mejor surtido para tu celebración.
                    </p>
                    <p class="text-denny-dark-400 text-sm lg:text-lg">
                        <small>
                            Promoción válida hasta el 30 de noviembre o agotar existencias.
                        </small>
                    </p>
                </div>
            </article>
            <article class="relative flex-shrink-0 w-full h-full">
                <picture class="w-full h-full block relative md:static">
                    <img
                        src="<?= base_url('images/pages/home/banner.webp') ?>"
                        alt="Banner - Dulcerias Denny"
                        class="w-full h-full object-cover"
                    >
                    <h2 class="absolute top-1/2 right-0 -translate-y-1/2 text-denny-blue-300 text-xl font-black md:hidden w-1/2">
                        Paquetes para Fiesta al 60% de Descuento
                    </h2>
                </picture>
                <div class="md:absolute md:top-1/2 md:right-0 md:-translate-y-1/2 md:w-7/12 md:px-2">
                    <h2 class="text-denny-blue-300 text-lg md:text-3xl lg:text-5xl font-black hidden md:block">
            ...
            <article class="relative flex-shrink-0 w-full h-full">
                <picture class="w-full h-full block relative md:static">
                    ...
                    >
                    <h2 class="absolute top-1/2 right-0 -translate-y-1/2 text-denny-blue-300 text-xl font-black md:hidden w-1/2">
                        Paquetes para Fiesta al 70% de Descuento
                    </h2>
                </picture>
                <div class="md:absolute md:top-1/2 md:right-0 md:-translate-y-1/2 md:w-7/12 md:px-2">
                    <h2 class="text-denny-blue-300 text-lg md:text-3xl lg:text-5xl font-black hidden md:block">
    ...
    <!-- Botones que controlan el desplazamiento del carrusel -->
    ...
    <!-- Fin de los botones que controlan el desplazamiento del carrusel -->
</section>
