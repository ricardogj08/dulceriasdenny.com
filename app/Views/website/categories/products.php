...
<?= $this->section('head') ?>
    <title>
        ★ Venta de Chocolates por Mayoreo en Dulcerías Denny
    </title>

    <meta
        name="description"
        content="Sorpréndete con nuestra amplia variedad de chocolates de la mejor calidad para tu negocio. ¡También tenemos chocolates para regalar en toda ocasión!"
    >
<?= $this->endSection() ?>
...
<?= $this->section('content') ?>
    ...
    <main class="">
        ...
        <div class="container py-8">
            ...
            <!-- More categories -->
            <section class="my-28">
                <h2 class="font-bold text-denny-blue-300 text-center text-xl">
