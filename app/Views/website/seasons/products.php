...
<?= $this->section('head') ?>
    <title>
        ★ Venta de Dulces Día de Muertos y Halloween | Dulcerías Denny
    </title>

    <meta
        name="description"
        content="Encuentra la más amplia variedad de chocolates, caramelos  y botanas que tenemos para celebrar Halloween y Día de muertos. ¡Endulza tu vida!'"
    >
<?= $this->endSection() ?>
