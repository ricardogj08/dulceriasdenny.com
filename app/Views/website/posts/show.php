...
<?= $this->section('head') ?>
    <title>
        ★ Blog de Dulcerías Denny | Todo sobre Dulces
    </title>

    <meta
        name="description"
        content="¡Deslúmbrate con nuestros tips y recetas con Dulces! Nuestros 30 años de experiencia nos respaldan para aconsejarte sobre caramelos, chocolates, y más."
    >
<?= $this->endSection() ?>
