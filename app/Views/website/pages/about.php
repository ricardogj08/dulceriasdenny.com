...
<?= $this->section('head') ?>
    <title>
        Distribuidor de dulces, botanas y caramelos por mayoreo
    </title>

    <meta
        name="description"
        content="Contamos con el más amplio surtido de dulces, botanas y caramelos, brindándote siempre un gran servicio y sobre todo el mejor precio. ¡Endulza tu vida!"
    >
<?= $this->endSection() ?>
        ...
        <div class="container">
            ...
            <section class="my-10 py-8 lg:p-0 lg:-mt-28">
                <header class="text-center">
                    <h2 class="text-denny-dark-500 font-black text-2xl">Visítanos</h2>
