...
<?= $this->section('head') ?>
    <title>
        ▷ Dónde Comprar Dulces al Mayoreo para Dulcerías o Negocios
    </title>

    <meta
        name="description"
        content="Ubica la Dulcería más cercana y encuentra los dulces que estás buscando. Sucursales en Celaya, León, Querétaro, Irapuato, Salamanca y más."
    >
<?= $this->endSection() ?>
        ...
        <section class="py-8 min-h-[350px] grid place-items-center bg-denny-light-200 text-denny-dark-400 ">
            <div class="container text-center">
                ...
                <div class="mt-6 grid gap-y-4 max-w-5xl mx-auto">
                    <p>En Dulcerías Denny contamos con todo lo necesario para adornar y endulzar tu tiendita, dulcería cooperativa, fiesta, evento, o reunión… lo que busques, ¡nosotros lo tenemos!</p>
