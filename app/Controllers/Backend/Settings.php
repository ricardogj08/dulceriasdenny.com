...
class Settings extends BaseController
{
    ...
    public function update()
    {
        ...
        // Modifica los emails de destino.
        ...
        setting()->set('App.apps', stripAllSpaces($this->request->getPost('whatsapp')) ?: null, 'whatsapp');
        ...
        // Modifica la clave de sitio web de Google reCAPTCHA.
        setting()->set('App.apps', stripAllSpaces($this->request->getPost('googleRecaptcha')) ?: null, 'google:recaptcha');
